...
#define OUT_PWM10 10 // PWM
#define OUT_PWM11 11 // PWM
...
#define OUT6 9 // off/on SSR
#define OUT7 12 // off/onvSSR
...
void setup()
{
  ...
  */
  ...
  pinMode(OUT_PWM10, OUTPUT);
  pinMode(OUT_PWM11, OUTPUT);
}
...
void loop()
{
  ...
  holdingRegs[DATA0] = 10;
  holdingRegs[DATA1] = errorcnt;

  digitalWrite(LED, (bool(holdingRegs[DATA2])));
    
  digitalWrite(OUT0, !(bool(holdingRegs[DATA3])));
  digitalWrite(OUT1, !(bool(holdingRegs[DATA4])));
  digitalWrite(OUT2, !(bool(holdingRegs[DATA5])));
  digitalWrite(OUT3, !(bool(holdingRegs[DATA6])));
  digitalWrite(OUT4, !(bool(holdingRegs[DATA7])));
  digitalWrite(OUT5, !(bool(holdingRegs[DATA8])));
  digitalWrite(OUT6, !(bool(holdingRegs[DATA9])));
  digitalWrite(OUT7, !(bool(holdingRegs[DATA10])));
  
  analogWrite(OUT_PWM10, holdingRegs[DATA11]);
  analogWrite(OUT_PWM11, holdingRegs[DATA12]);
}
